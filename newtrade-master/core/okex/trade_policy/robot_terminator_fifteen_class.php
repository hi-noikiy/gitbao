...
class RobotTerminatorFifteenClass extends BaseAbstractClass implements BaseInterface
{
    ...
    private $_week_min = "15min";
    //止盈系数
    private $_ratio = 1.018;
    //仓位系数
    private $_usdt_ratio = 0.04;
